...
$(function() {
	...
	$("body").on("click", '.map-detail-mapBox .back-btn', function() {
		
		
		$("#map-detail-mapBox-id").addClass('close-active')
		setTimeout(function() {
			changeProvinceName('');
			$("#map-detail-mapBox-id").removeClass('close-active')
		}, 1000);
	...
	$(".map-detail .info-list").scroll(function() {
		let yihuadong1 = $(this).scrollTop();
		let gundongkuang =  $(this).innerHeight();
		let huadongjulu1 = $(this).find('.info-list-content').innerHeight();
	

		
		let bili = yihuadong1 / (huadongjulu1 - gundongkuang);
		console.log(yihuadong1)
		console.log(huadongjulu1)
		console.log(gundongkuang)
		console.log(bili)
...
function changeProvinceName(thisProvinceName) {
	...
	if (provinceName === '') {
		$(".map-detail .info-list").scrollTop(0)
...
function setScroll() {
	...
	let yinyanTop = $("#yinyan").offset().top;
	
	if (windowTop+1 > yinyanTop) {
		$(".mulu-box").show()
	}else{
		$(".mulu-box").hide()
	}
	...
	if (ssss - windowHeight + videoHeight < 0 && ssss > 0) {
	...
	if (s2 - windowHeight +muer_mount_videoHeight < 0 && s2 > 0) {
